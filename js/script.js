...
const getMovies = () => {
    // 'movies' is arbitrary, stand in for 'data'
        ...
        for (let movie of movies) {
            htmlStr += `
                 <div id=${movie.id.toString()} class="card m-1 mb-5 p-0" style="width: 18rem;">
                      ...
                      <div class="card-body">
                        <h5 id="title-${movie.id}" class="title">${movie.title.toUpperCase()}</h5>
            ...
            $('i.editButton').click(function () {
                ...
                let title = editItem.find('.title').attr('contenteditable', 'true');
                ...
                let rating = editItem.find('.rating').attr('contenteditable', 'true');
